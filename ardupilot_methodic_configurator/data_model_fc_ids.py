...
VID_VENDOR_DICT: dict[int, list[str]] = {
    0x26AC: ["3DR"],
    0x1209: ["ArduPilot", "AET", "Airvolute", "Aocoda-RC-H743Dual", "CSKY", "AMOV", "GreenSight", "Japan Aviation Electronics Industry Ltd.", "Taiphoon", "mRo", "ORBITH743", "ORBITH743v2", "Horizon31", "Dheeran labs", "PrincipIoT", "Qiotek", "Sierra Aerospace", "SkySakura"],
...
# Maps 16-bit APJ board ID to board name(s) for 314 supported boards
...
# Maps 16-bit APJ board ID to board vendor for 314 supported boards
APJ_BOARD_ID_VENDOR_DICT: dict[int, list[str]] = {
    ...
    58: ["ArduPilot"],  # ARK_PI6X
    61: ["ArduPilot"],  # ARKV6S
    57: ["ArduPilot"],  # ARKV6X
    1227: ["ArduPilot"],  # Atlas-Control
    1078: ["ArduPilot"],  # AtomRCF405NAVI
    1143: ["ArduPilot"],  # ATOMRCF405NAVI-Deluxe
    1511: ["ArduPilot"],  # BCubeF745v2
    ...
    1229: ["ArduPilot"],  # CORVON743V2
    1211: ["ArduPilot"],  # CORVON_V5
    1177: ["ArduPilot"],  # CrazyF405
    12: ["ArduPilot"],  # crazyflie2
    1158: ["CSKY"],  # CSKY405
    1212: ["ArduPilot"],  # CSKY_PMU
    ...
    5830: ["ArduPilot"],  # CyberX-v10
    1190: ["ArduPilot"],  # DAKEFPVF405
    1193: ["ArduPilot"],  # DAKEFPVH743
    1208: ["ArduPilot"],  # DAKEFPVH743_SLIM
    ...
    1531: ["ArduPilot"],  # F4BY_H743
    1218: ["AMOV"],  # flycore
    1226: ["ArduPilot"],  # FlyFishRCF405
    ...
    4002: ["ArduPilot"],  # KARSHAKH743VTOL
    1315: ["ArduPilot"],  # kha_eth
    1250: ["ArduPilot"],  # KT-FMU-F1
    7140: ["ArduPilot"],  # Lectron-Pi5-H7
    ...
    1207: ["ArduPilot"],  # NucleoH753ZI
    5730: ["ArduPilot"],  # NWBLUE_PROH757
    ...
    1219: ["ORBITH743v2"],  # ORBITH743v2
    1155: ["ArduPilot"],  # OrqaF405Pro
    1204: ["ArduPilot"],  # OrqaH7QuadCore
    1213: ["ArduPilot"],  # PilotGaeaSH7V1
    ...
    7101: ["ArduPilot"],  # VUAV-TinyV7
    7100: ["ArduPilot"],  # VUAV-V7pro
    1203: ["ArduPilot"],  # X-MAV-AP-H743r1
    1174: ["ArduPilot"],  # X-MAV-AP-H743v2
    1235: ["ArduPilot"],  # YARI_GNSS
...
# Maps 16-bit APJ board ID to MCU series for 314 supported boards
APJ_BOARD_ID_MCU_SERIES_DICT: dict[int, list[str]] = {
    ...
    58: ["STM32H7xx"],  # ARK_PI6X
    61: ["STM32H7xx"],  # ARKV6S
    57: ["STM32H7xx"],  # ARKV6X
    1227: ["STM32H7xx"],  # Atlas-Control
    1078: ["STM32F4xx"],  # AtomRCF405NAVI
    1143: ["STM32F4xx"],  # ATOMRCF405NAVI-Deluxe
    1511: ["STM32F7xx"],  # BCubeF745v2
    ...
    1229: ["STM32H7xx"],  # CORVON743V2
    1211: ["STM32F7xx"],  # CORVON_V5
    1177: ["STM32F4xx"],  # CrazyF405
    12: ["STM32F4xx"],  # crazyflie2
    1158: ["STM32F4xx"],  # CSKY405
    1212: ["STM32F4xx"],  # CSKY_PMU
    ...
    5830: ["STM32H7xx"],  # CyberX-v10
    1190: ["STM32F4xx"],  # DAKEFPVF405
    1193: ["STM32H7xx"],  # DAKEFPVH743
    1208: ["STM32H7xx"],  # DAKEFPVH743_SLIM
    ...
    1531: ["STM32H7xx"],  # F4BY_H743
    1218: ["STM32H7xx"],  # flycore
    1226: ["STM32F4xx"],  # FlyFishRCF405
    ...
    4002: ["STM32H7xx"],  # KARSHAKH743VTOL
    1315: ["STM32H7xx"],  # kha_eth
    1250: ["STM32H7xx"],  # KT-FMU-F1
    7140: ["STM32H7xx"],  # Lectron-Pi5-H7
    ...
    1207: ["STM32H7xx"],  # NucleoH753ZI
    5730: ["STM32H7xx"],  # NWBLUE_PROH757
    ...
    1219: ["STM32H7xx"],  # ORBITH743v2
    1155: ["STM32F4xx"],  # OrqaF405Pro
    1204: ["STM32H7xx"],  # OrqaH7QuadCore
    1213: ["STM32H7xx"],  # PilotGaeaSH7V1
    ...
    7101: ["STM32H7xx"],  # VUAV-TinyV7
    7100: ["STM32H7xx"],  # VUAV-V7pro
    1203: ["STM32H7xx"],  # X-MAV-AP-H743r1
    1174: ["STM32H7xx"],  # X-MAV-AP-H743v2
    1235: ["STM32F4xx"],  # YARI_GNSS
...
# Maps MCU series to 16-bit APJ board ID for 314 supported boards
MCU_SERIES_APJ_BOARD_ID_DICT: dict[str, list[int]] = {
    "CKS32F4xx": [1134, 1065],  # AR-F407SmartBat, QioTekAdeptF407
    "STM32F4xx": [1115, 1116, 128, 83, 1078, 1143, 1125, 1044, 2501, 1184, 5811, 1085, 1064, 1187, 1177, 12, 1158, 1212, 9, 1003, 1190, 5800, 13, 135, 20, 1530, 1226, 1067, 1068, 1361, 1180, 1137, 1099, 1157, 1119, 5401, 1081, 1059, 1412, 1169, 122, 5406, 1030, 1422, 11, 1038, 1019, 125, 1014, 1054, 127, 6101, 1161, 1150, 88, 3, 1002, 131, 137, 133, 1155, 1140, 1096, 1076, 1107, 1021, 1417, 124, 1316, 1052, 1055, 1034, 1095, 1201, 130, 1197, 134, 5271, 1135, 1106, 1082, 1136, 5272, 1500, 1504, 1011, 6001, 6002, 6000, 5251, 212, 213, 1151, 1152, 1154, 1910, 1351, 1235],  # ACNS-CM4Pilot, ACNS-F405AIO, airbotf4, ARK_CANNODE, AtomRCF405NAVI, ATOMRCF405NAVI-Deluxe, BETAFPV-F405, BirdCANdy, BOTWINGF405, BrahmaF4, BROTHERHOBBYF405v3, C-RTK2-HP, CarbonixF405, CORVON405V2_1, CrazyF405, crazyflie2, CSKY405, CSKY_PMU, CUAV-Pixhack-v3, CubeBlack, CubeGreen-solo, CubePurple, CubeSolo, fmuv2, fmuv3, mRoX21, Pixhawk1, Pixhawk1-1M, skyviper-f412-rev1, skyviper-journey, skyviper-v2450, CubeBlack+, DAKEFPVF405, DroneerF405, DrotekP3Pro, F35Lightning, F4BY, F4BY_F427, FlyFishRCF405, FlyingMoonF407, FlyingMoonF427, FlysparkF4, FlywooF405HD-AIOv2, FlywooF405Pro, FlywooF405S-AIO, FoxeerF405v2, HEEWING-F405, HEEWING-F405v2, HolybroF4_PMU, JHEM_JHEF405, JHEMCU-GSF405A, JHEMCU-GSF405A-RX2, JHEMCUF405PRO, JHEMCUF405WING, KakuteF4, KakuteF4-Wing, KakuteF4Mini, LongBowF405WING, luminousbee4, Pixracer, MambaF405-2022, MambaF405v2, MatekF405, MatekF405-STD, MatekF405-CAN, MatekF405-TE, MatekF405-Wing, MFE_POS3_CAN, MicoAir405Mini, MicoAir405v2, mindpx-v2, mini-pix, omnibusf4, omnibusf4pro, omnibusf4pro-one, omnibusf4v6, OmnibusNanoV6, OrqaF405Pro, PixPilot-C3, PixPilot-V3, PixSurveyA1, PixSurveyA1-IND, QioTekZealotF427, RadiolinkF405, revo-mini, revo-mini-i2c, revo-mini-sd, SaamPixV1_1, Sierra-F405, Sierra-F412, Sierra-F9P, Sierra-PrecisionPoint, SkystarsF405v2, sparky2, SPEDIXF405, speedybeef4, SpeedyBeeF405AIO, SpeedyBeeF405Mini, SpeedyBeeF405WING, speedybeef4v3, speedybeef4v4, speedybeef4v5, StellarF4, StellarF4V2, SuccexF4, sw-boom-f407, sw-nav-f405, sw-spar-f407, TBS_LUCID_PRO, thepeach-k1, thepeach-r1, VRBrain-v51, VRBrain-v52, VRBrain-v54, VRCore-v10, VRUBrain-v51, YARI_GNSS
